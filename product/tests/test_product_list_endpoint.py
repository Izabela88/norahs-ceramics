...
@pytest.mark.django_db
def test_product_list_return_list_of_products(client):
...
@pytest.mark.django_db
def test_product_list_return_list_is_paginated(client):
    category = factories.CategoryModelFactory()
    sub_category = factories.SubCategoryModelFactory(category=category)
...
@pytest.mark.django_db
def test_product_list_return_next_page_content(client):
    category = factories.CategoryModelFactory()
    sub_category = factories.SubCategoryModelFactory(category=category)
...
@pytest.mark.django_db
def test_product_list_return_only_active_products(client):
    category = factories.CategoryModelFactory()
    sub_category = factories.SubCategoryModelFactory(category=category)
